...
dim = 10*10*5  # dimension of the matrix
...
M = np.eye(dim)*(3j+1)
eigs_analytical = random_complex_array/(3j+1)
# the algorithm doesn;t work because M is not hermitian (the M != M^*.T)
