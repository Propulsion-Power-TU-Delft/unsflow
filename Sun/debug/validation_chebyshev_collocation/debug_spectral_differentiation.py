...
contour00 = ax[0, 0].contourf(X_fine, Y_fine, Z_fine, cmap=cm.viridis, levels=N_levels)
contour01 = ax[0, 1].contourf(X_fine, Y_fine, dZdX_fine, cmap=cm.viridis, levels=N_levels)
contour02 = ax[0, 2].contourf(X_fine, Y_fine, dZdY_fine, cmap=cm.viridis, levels=N_levels)
...
contour10 = ax[1, 0].contourf(X_gl, Y_gl, Z_gl, cmap=cm.viridis, levels=N_levels)
...
contour11 = ax[1, 1].contourf(X_gl, Y_gl, dZdX_gl, cmap=cm.viridis, levels=N_levels)
contour12 = ax[1, 2].contourf(X_gl, Y_gl, dZdY_gl, cmap=cm.viridis, levels=N_levels)
