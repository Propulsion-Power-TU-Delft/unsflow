...
import os
from Sun.src.general_functions import annular_duct_analytical_transformation
...
dxi_dz = annular_duct_analytical_transformation(z / x_ref, 0 / x_ref, L / x_ref)
deta_dr = annular_duct_analytical_transformation(r / x_ref, r1 / x_ref, r2 / x_ref)
...
sun_obj.ComputeJacobianPhysical(order=gradient_order, routine=gradient_routine)
