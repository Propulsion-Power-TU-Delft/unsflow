...
omega_domain = [50e3, 65e3, -8e3, 8e3]
grid_omega = [50, 15]
sun_obj.ComputeSVD(omega_domain = omega_domain / omega_ref, grid_omega = grid_omega)
sun_obj.PlotInverseConditionNumber(ref_solution=omega_analytical, save_filename='chi_map_geo_03_%d_%d'
                                                                                %(Nz, Nr))
