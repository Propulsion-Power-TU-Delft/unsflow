...
eig_unst_rs = [-eigs[1, 0] for eigs in data]
eig_unst_df = [eigs[1, 1] for eigs in data]

# plt.figure()
# plt.plot(simsmass, eig_unst_rs,  '-o')
...
#
# plt.figure()
# plt.plot(simsmass, eig_unst_df, '-o')
# plt.plot(simsmass, [0, 0, 0, 0],  '--r', linewidth=1)
# plt.xlabel(r'$\dot{m}$ [kg/s]')
# plt.ylabel(r'RS')
# plt.grid(alpha=0.2)
# plt.savefig('df.pdf', bbox_inches='tight')
