...
meridional_objs = []
pickle_files = ['data/nasar37_p128_10_10_15_10.pickle', 'data/nasar37_p128_20_20_35_20.pickle', 'data/nasar37_p128_30_30_50_30.pickle']
for pickle_file in pickle_files:
    with open(pickle_file, "rb") as file:
        meridional_objs.append(pickle.load(file))

# STABILITY ANALYSIS
sun_blocks = []
for meridional_obj in meridional_objs:
    compressor_grid = Sun.src.sun_grid.SunGrid(meridional_obj.group[1])
...
for sun_obj in sun_blocks:
    ...
    sun_obj.ContourTransformation(folder_name=folder_out, save_filename='%i' %(ii))
