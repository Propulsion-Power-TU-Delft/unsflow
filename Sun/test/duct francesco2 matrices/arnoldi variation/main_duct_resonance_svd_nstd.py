...
# sun_obj.PlotInverseConditionNumber(ref_solution=omega_analytical, save_filename='chi_map_svd_%d_%d' %(Nz, Nr))
#
sun_obj.ComputeSVD2(omega_domain = omega_domain/omega_ref, grid_omega = grid_omega)
sun_obj.PlotInverseConditionNumber(ref_solution=omega_analytical, save_filename='chi_map_svd_nstd_%d_%d' %(Nz, Nr))
