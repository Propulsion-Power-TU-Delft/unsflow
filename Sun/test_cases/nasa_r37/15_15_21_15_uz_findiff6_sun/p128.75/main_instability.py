...
ii = 0
for idx, sun_obj in enumerate(sun_blocks):
    print('\nBlock Number ', idx+1)
    sun_obj.ComputeBoundaryNormals()
    sun_obj.ComputeSpectralGrid()
    sun_obj.ComputeJacobianPhysical()
    sun_obj.AddAMatrixToNodes_sun()
    sun_obj.AddBMatrixToNodes_sun()
    sun_obj.AddCMatrixToNodes_sun()
    sun_obj.AddEMatrixToNodes_sun()
    sun_obj.AddRMatrixToNodes_sun()
    ...
    sun_obj.compute_L_matrices(idx)
