...
omega_domain = [12e3, 35e3, -8e3, 8e3]
grid_omega = [50, 15]
sun_obj.ComputeSVD(omega_domain = omega_domain / omega_ref, grid_omega = grid_omega)
sun_obj.PlotInverseConditionNumber(ref_solution=omega_analytical, save_filename='chi_map_geo_02_%s_%d_%d'
                                                                                %(gradient_routine, Nz, Nr))
