...
sun_obj.ComputeJacobianPhysical(routine=gradient_routine)
...
sun_obj.PlotInverseConditionNumber(ref_solution=omega_analytical, save_filename='chi_map_%s_%d_%d_m%d'
                                                                                %(gradient_routine, Nz, Nr, m))
