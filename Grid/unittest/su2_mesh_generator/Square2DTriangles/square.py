...
parser.add_option("-n", "--nNode", dest="nNode", default=20, help="use this NNODE in x direction", metavar="NNODE")
parser.add_option("-m", "--mNode", dest="mNode", default=20, help="use this MNODE in x direction", metavar="MNODE")
