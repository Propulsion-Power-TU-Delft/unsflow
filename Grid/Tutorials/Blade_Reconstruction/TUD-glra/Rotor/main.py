...
bladed_block.plot_full_grid(save_filename='TUD-Rotor')

blade.add_meridional_grid(bladed_block.z_grid_cg, bladed_block.r_grid_cg)
blade.compute_streamline_length()
blade.plot_streamline_length_contour(save_filename='TUD-Rotor')
blade.compute_spanline_length()
blade.plot_spanline_length_contour(save_filename='TUD-Rotor')
blade.obtain_quantities_on_meridional_grid_secondversion()
blade.compute_camber_vectors()
blade.plot_camber_surface()
blade.plot_camber_normal_contour(save_filename='TUD-Rotor')
blade.plot_blockage_contour(save_filename='TUD-Rotor')
blade.compute_blade_camber_angles()
blade.show_blade_angles_contour(save_filename='TUD-Rotor')
blade.plot_inlet_outlet_metal_angle(save_filename='TUD-Rotor')
