...
bladed_block.plot_full_grid(save_filename='HECC')
...
blade.compute_blade_blockage_gradient(save_filename='HECC')
blade.plot_blockage_and_grad_leading_to_trailing(save_filename='HECC')
