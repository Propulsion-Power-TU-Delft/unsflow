...
contour_template(xData, yData, zData, 'z', save_filename='reference_data')
contour_template(xEval, yEval, zEval, 'z', save_filename='linear_interpolation_nearest_extrapolation')
contour_template(xEval, yEval, zEval2, 'z', save_filename='linear_interpolation_linear_stream-span_extrapolation')
