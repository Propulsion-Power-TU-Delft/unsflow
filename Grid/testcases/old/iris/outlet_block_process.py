...
blade.find_inlet_points(geometry_type='radial')
blade.find_outlet_points(geometry_type='radial')
...
block.compute_grid_points(grid_mode='elliptic',
                          orthogonality=False, x_stretching=False, y_stretching=False, method='minimize',
                          sigmoid_coeff_x=10, sigmoid_coeff_y=5)
