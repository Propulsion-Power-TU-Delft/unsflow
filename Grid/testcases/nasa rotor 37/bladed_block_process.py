...
data_process.circumferential_average(mode='cell centered', bfm='radial', fix_borders=False, gauss_filter=True)
# data_process.compute_rbf_fields()
# data_process.compute_interpolated_fields()
# data_process.compute_rbf_gradients()
# data_process.compute_rbf_gradients_symbolic()
