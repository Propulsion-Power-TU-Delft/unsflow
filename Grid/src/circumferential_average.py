...
def circumferential_average_CFD_dataset(folderpath, extraction_method, spanwiseProfilePath):
    ...
    """
    spanData = np.loadtxt(spanwiseProfilePath, delimiter=',', skiprows=1)[:,-1]
    ...
    with open(output_folder + '/' + filename, 'wb') as f:
        fields_rawAvg['Streamwise_Coordinate'] = np.reshape(spanData, (nstream, nspan))
    ...
    with open(output_folder + '/' + filename, 'wb') as f:
        fields_densityAvg['Streamwise_Coordinate'] = np.reshape(spanData, (nstream, nspan))
    ...
    with open(output_folder + '/' + filename, 'wb') as f:
        fields_axialMomentumAvg['Streamwise_Coordinate'] = np.reshape(spanData, (nstream, nspan))
