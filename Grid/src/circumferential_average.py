...
def circumferential_average_CFD_dataset_marble(folderpath):
    pass
...
def circumferential_average_CFD_dataset(folderpath, extraction_method='kiwada'):
    ...
    z_grid = np.zeros((nstream, nspan))
    r_grid = np.zeros((nstream, nspan))
    fields_thetaAvg = {}
    fields_densityAvg = {}
