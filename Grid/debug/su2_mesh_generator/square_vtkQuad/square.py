...
parser.add_option("-n", "--nNode", dest="nNode", default=50, help="use this NNODE in x direction", metavar="NNODE")
parser.add_option("-m", "--mNode", dest="mNode", default=50, help="use this MNODE in x direction", metavar="MNODE")
...
for jNode in range(mNode - 1):
    for iNode in range(nNode - 1):
        zero = jNode * nNode + iNode
        one = jNode * nNode + iNode + 1
        two = (jNode + 1) * nNode + iNode + 1
        three = (jNode + 1) * nNode + iNode
