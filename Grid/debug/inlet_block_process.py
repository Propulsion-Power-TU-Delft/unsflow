...
block.find_border()
block.plot_full_grid(save_filename='inlet_grid_%2d_%2d' % (nstream, nspan))
...
data_process.store_pickle(folder='data/meta/', file_name='iris_inlet_data_%2d_%2d' % (nstream, nspan))
end_time = time.time()
