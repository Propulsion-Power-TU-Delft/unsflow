...
if INLET_BLOCK:
    ...
    block.plot_full_grid(primary_grid_points=True, secondary_grid=True, secondary_grid_points=True)
    block.compute_total_area()
    block.plot_check_areas()
    ...
    inlet_process.contour_plot('drho_dr')
    inlet_process.contour_plot('drho_dz')
    inlet_process.compute_green_gauss_gradients()
    inlet_process.contour_plot('drho_dr')
    inlet_process.contour_plot('drho_dz')
#
