...
from spakovszky.src.axial_stator import AxialStator
from spakovszky.src.axial_gap import AxialGap
from spakovszky.src.axial_rotor import AxialRotor
...
for DeltaX in gap:
    ...
    driver.plot_eigenvalues([-4.5, 0.5, -0.5, 2], save_filename='rotor_stator_gap_%.3f' %(DeltaX))
    driver.store_results_pickle(save_filename='rotor_stator_gap_%.3f' %(DeltaX))
