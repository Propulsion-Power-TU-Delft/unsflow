...
lambda_span = np.linspace(1, 300, 1000)  # we will do a loop for every possible value of lambda
...
roots = find_multiple_zeros(lambda_root, lambda_span.min(), lambda_span.max(), intervals=9)
...
omega_analytical = compute_omega(alpha, roots[0:3], M, L, a)
